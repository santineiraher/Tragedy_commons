...
num_individuals = 100  # Number of individuals (nodes) in the graph
num_links = 50 # Number of connections (edges) in the graph
...
def run_single_simulation(num_individuals, num_links):
    graph = nx.barabasi_albert_graph(num_individuals, num_links)
...
file_name = (
    f'sim_Barabasi_{num_individuals}_{num_links}_coop_{p_cooperative}_beta_{beta}_mu_{mu}_T_{T}_'
